...
<div class="container-fluid">
<div class="row">
<div class="col-md-12 "><h1>Qanunvericilik</h1></div>
<br>
</div>
...
$query="DELETE FROM qanun WHERE f_id='{$chekBoxValue}' ";
...
<!--        ___________________________________________________________-->
        ...
        <div class="row gap-1 mb-2">
        <div id="bulkOptionsContainer" class="col-4">
<a class="btn btn-success" data-toggle="modal" data-target="#add_qanun" href="add_qanun.php"><i class="fas fa-rss"></i> Qanun əlavə edin</a>
        </div>
        <div class="col-2">
...
<th class="th_post" scope="col">OP</th>
 ...
 $sql_xercler = "SELECT * FROM `qanun`  ";
    $result_xerrc= mysqli_query($con, $sql_xercler);
    
    // output data of each row
while($row_ins_type = mysqli_fetch_assoc($result_xerrc)) {
$f_id=$row_ins_type['f_id'];    
$f_name=$row_ins_type['f_name'];
$file_link=$row_ins_type['f_link'];
$file_date=$row_ins_type['f_date'];
...
<tbody>
<tr>
<td><input class='checkBoxes' value="<?php echo $f_id; ?>" type='checkbox' name='checkBoxArray[]'></td>
<td class="th_post"><?php echo $f_id;?></td>
<td class="th_post"><?php echo $f_name;?></td>
<td class="th_post"><?php echo $file_link;?></td>
<td class="th_post"><?php echo $file_date;?></td>

<td>
<button class="btn btn-warning" data-toggle="modal" type="button" data-target="#update_modal<?php echo $f_id;?>"><span class="glyphicon glyphicon-edit"></span> Edit</button>
</td>
