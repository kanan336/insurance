...
<h1 class="h3 mb-0 text-gray-800">Şəxsi məlumatlar</h1>
<br>
<?php
...
if(isset($_GET['editprofile'])){
    ...
    //$query.= "post_date = now() " ;
    $sql_edit_profile.= "WHERE id = {$session_user_id} " ;
...
<input type="text" class="form-control" value="<?php echo $usertype;?>" id="inputPassword4" placeholder="Password">
</div>      
