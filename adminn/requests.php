...
<td class="th_post"><a href="bloq_admin.php?delete_sec_img1=<?php echo $post_id; ?>" title="delete" class="delete" onclick="return confirm('Are you sure you want to delete this item')"> <img width="100%" alt="image" src="img/xeberler/<?php echo $post_image;?>"></a></td>
...
<td class="th_post"><a href="bloq_admin.php?delete_sec_img=<?php echo $post_id; ?>" title="delete" class="delete" onclick="return confirm('Are you sure you want to delete this item')"> <img width="100%" alt="image" src="img/xeberler/<?php echo $post_image1;?>"></a></td>
