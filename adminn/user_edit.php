...
<h1 class="h3 mb-0 text-gray-800">Edit istifadəçi</h1>
<br>
<?php
...
if(isset($_GET['edt'])){
    ...
    $sql = "SELECT * FROM users WHERE id='$edtUserID' ";
...
if(isset($_GET['editprofile'])){
    ...
    //$query.= "post_date = now() " ;
    $sql_edit_profile.= "WHERE id = {$editUserID} " ;
...
<div class="form-group col-md-12">
 ...
 <a href="user_list.php" type="button" class="btn btn-danger" >Imtina</a>
</div>      
...
<input type="text" value="<?php echo $edtUserID;?>" name="ses"   class="input form-control" id="password1"  />
</div>
</div>
